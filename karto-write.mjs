...
export function addAccount(o = {}) {
  ...
  if (noSecret(o.note, o.identity, o.email, o.url, o.plan, o.id)) return SECRET_ERR;
  ...
  const row = { id, provider: o.provider, identity: o.identity || null, email: o.email || null, url: o.url || null, plan: o.plan || null, category: o.category || null, note: o.note || null };
